  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>wpzoom 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ WPZOOM.title }}</h1>
        <copyright-meta
          :designer="WPZOOM.designer"
          :homepage="WPZOOM.homepage"
          :license="WPZOOM.license" />
    ...
    <base-footer
      ...
      <div class="util-align-right base-footer__navigation">
        Next Page：
        <router-link to="/zondicons">Zondicons 图标库</router-link>
      </div>
    </base-footer>
  </base-container>
</template>
...
import WPZOOM from '../../assets/wpzoom'

export default {
  name: 'PageWpzoom',
  componentName: 'PageWpzoom',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
