  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Hawcons 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ HAWCONS.title }}</h1>
        <copyright-meta
          :designer="HAWCONS.designer"
          :homepage="HAWCONS.homepage"
          :license="HAWCONS.license" />
...
import HAWCONS from '../../assets/hawcons'

export default {
  name: 'PageHawcons',
  componentName: 'PageHawcons',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
