  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Vicons 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ VICONS.title }}</h1>
        <copyright-meta
          :designer="VICONS.designer"
          :homepage="VICONS.homepage"
          :license="VICONS.license" />
...
import VICONS from '../../assets/vicons'

export default {
  name: 'PageVicons',
  componentName: 'PageVicons',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
