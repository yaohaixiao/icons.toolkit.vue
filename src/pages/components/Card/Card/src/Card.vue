...
<script>
/**
 * Card.vue - Icon 示例卡片组件
 * =============================================================
 * Created By: Yaohaixiao
 * Update: 2022.11.10
 */
import CardMarked from '@/pages/components/Card/Marked'
import CardSvg from '@/pages/components/Card/Svg'
import CardName from '@/pages/components/Card/Name'
import CardToolbar from '@/pages/components/Card/Toolbar'
