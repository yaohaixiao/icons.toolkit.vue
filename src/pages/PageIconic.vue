  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Iconic 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ ICONIC.title }}</h1>
        <copyright-meta
          :designer="ICONIC.designer"
          :homepage="ICONIC.homepage"
...
import ICONIC from '../../assets/iconic'

export default {
  name: 'PageIconic',
  componentName: 'PageIconic',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
