  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Linecons 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ LINECONS.title }}</h1>
        <copyright-meta
          :designer="LINECONS.designer"
          :homepage="LINECONS.homepage"
          :license="LINECONS.license" />
...
import LINECONS from '../../assets/linecons'

export default {
  name: 'PageLinecons',
  componentName: 'PageLinecons',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
