  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Entypo+ 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ ENTYPO.title }}</h1>
        <copyright-meta
          :designer="ENTYPO.designer"
          :homepage="ENTYPO.homepage"
          :license="ENTYPO.license" />
...
import ENTYPO from '../../assets/entypo'

export default {
  name: 'PageEntypoPlus',
  componentName: 'PageEntypoPlus',
  components: {
    BaseContainer,
    BaseHeader,
    BaseMain,
