  ...
  <base-container>
    <base-header
      ...
      <base-breadcrumb>
        ...
        <base-breadcrumb-item current>Material 图标集</base-breadcrumb-item>
      </base-breadcrumb>
    ...
    <base-main padding="outer">
      <article class="article">
        <h1 class="article__h1">{{ MATERIAL.title }}</h1>
        <copyright-meta
    ...
    <base-footer
      ...
      <div class="util-align-left base-footer__navigation">
        Prev Page：
        <router-link to="/linecons">Linecons 图标库</router-link>
      </div>
...
<script>
/**
 * PageMaterial.vue - 列表页面
 * =============================================================
 * Created By: PageMaterial
 * Update: 2023.10.18
 */
// 公共组件
